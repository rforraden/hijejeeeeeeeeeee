...
function showMessage(response) {
    if (response === "No") {
        ...
        if(noClickCount <= 5){
            ...
            questionElement.textContent =  "Okay Pookie, sorry for insisting so much. Of course I respect your boundaries and I'm sorry if I was being too pushy. I hope you have a fantastic Day! And don't forget to drink water 🥛"
    ...
    if (response === "Yes") {
        ...
        yesMessage.textContent = "AAAAAA WERE OFFICIAL NOW?!? OUCH OUCH OUCH, HI  BBY";
